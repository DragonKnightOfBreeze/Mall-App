...
_227();
_228();
var _229=$(_224).panel("header.html");
...
$(_259).panel("header.html").find("div.panel-title").html(_25a);
};
var _25b=null;
...
return $.extend({},$.parser.parseOptions(_26d,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method","header.html","footer",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),header:(hh.length?hh.removeClass("panel-header"):undefined),footer:(ff.length?ff.removeClass("panel-footer"):undefined)});
};
...
var p=_2cd[i];
var h=p.panel("header.html")._outerHeight(_2ce);
...
var _2ee=$(this).panel("header.html");
...
var _2ef=$(this).panel("header.html");
...
$(_352).tabs("update",{tab:pp,options:pp.panel("options"),type:"header.html"});
};
...
if(_364.type=="all"||_364.type=="header.html"){
var tab=opts.tab;
if(opts.header){
...
var tool=$(this).panel("header.html").children("div.panel-tool");
tool.children("a.panel-tool-collapse").hide();
...
var _6f3=Math.max(_6f4("header.html"),_6f4("allbody"),_6f4("allfooter"))+1;
