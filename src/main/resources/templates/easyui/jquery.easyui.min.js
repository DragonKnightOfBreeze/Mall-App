...
_227();
_228();
var _229=$(_224).panel("templates.admin.fragment.header.html");
...
$(_259).panel("templates.admin.fragment.header.html").find("div.panel-title").html(_25a);
};
var _25b=null;
...
return $.extend({},$.parser.parseOptions(_26d,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method","templates.admin.fragment.header.html","footer",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),header:(hh.length?hh.removeClass("panel-header"):undefined),footer:(ff.length?ff.removeClass("panel-footer"):undefined)});
};
...
var p=_2cd[i];
var h=p.panel("templates.admin.fragment.header.html")._outerHeight(_2ce);
...
var _2ee=$(this).panel("templates.admin.fragment.header.html");
...
var _2ef=$(this).panel("templates.admin.fragment.header.html");
...
var _2f0=pp.panel("templates.admin.fragment.header.html");
...
$(_352).tabs("update",{tab:pp,options:pp.panel("options"),type:"templates.admin.fragment.header.html"});
};
...
if(_364.type=="all"||_364.type=="templates.admin.fragment.header.html"){
var tab=opts.tab;
if(opts.header){
...
var tool=$(this).panel("templates.admin.fragment.header.html").children("div.panel-tool");
tool.children("a.panel-tool-collapse").hide();
...
var _6f3=Math.max(_6f4("templates.admin.fragment.header.html"),_6f4("allbody"),_6f4("allfooter"))+1;
...
function _6f4(type){
var _6f5=0;
if(type=="templates.admin.fragment.header.html"){
_6f5=_6f6(_6f2);
}else{
